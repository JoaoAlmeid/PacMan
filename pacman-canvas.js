	...
	function doKeyDown(evt) {
		...
		switch (evt.keyCode) {
			...
			case 68: // Tecla D >
				pacman.directionWatcher.set(right);
				break;
			case 78: // Tecla N -> Novo jogo
				if (!$('#playerName').is(':focus')) {
					game.pause = 1;
					game.newGame();
				}
				break;
			case 77: // M -> Mutar o jogo
				game.toggleSound();
				break;
			case 8: // DEl -> Voltar ao conteudo do jogo 
			case 27: // ESC -> Voltar ao conteudo do jogo 
				if (!$('#playerName').is(':focus')) {
					evt.preventDefault();
					game.showContent('game-content');
				}
				break;
			case 32: // ESPAÇO -> Pausar o jogo
				evt.preventDefault();
